...
public class PostFragment extends Fragment implements SelectPhotoDialog.OnPhotoSelectedListener {
    ...
    private EditText mTitle, mDescription, mPrice, mCountry, mStateProvince, mCity, mContactNumber;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mContactNumber = view.findViewById(R.id.input_number);
        ...
        mPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isEmpty(mTitle.getText().toString())
                        ...
                        && !isEmpty(mContactNumber.getText().toString())){
