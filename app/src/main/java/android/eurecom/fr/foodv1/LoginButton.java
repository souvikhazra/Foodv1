...
public class LoginButton extends View {
    ...
    private void init() {
        ...
        loginButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.login_background_color));
        loginButtonPaint.setStyle(FILL);

        signUpButtonPaint = new Paint();
        signUpButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.register_background_color));
...
//        signUpPaint.setAlpha(255);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        orPaint.getTextBounds("or".toUpperCase(), 0, 2, r);
